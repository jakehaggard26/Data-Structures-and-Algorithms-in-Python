...
class TestNode(unittest.TestCase):
    ...
    def test_string_representation(self: Node) -> None:
        ...
        self.assertEqual(node.get_element(), "Hello, World!")
    ...
    def test_float_representation(self: Node) -> None:
        node = Node(3.14)
        self.assertEqual(node.get_element(), 3.14)
    
    def test_list_representation(self: Node) -> None:
        node = Node([1,2,3,4,5])
        self.assertEqual(node.get_element(), [1,2,3,4,5])
    
    def test_Node_representation(self: Node) -> None:
        node = Node(Node(1))
        self.assertEqual(node.get_element(), Node(1))
    ...
    def test_set_element(self: Node) -> None:
        node = Node(1)
